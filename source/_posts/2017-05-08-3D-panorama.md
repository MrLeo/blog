...
![全景漫游常见制作方法对比](http://isux.tencent.com/wp-content/uploads/2016/03/20160329103750899.jpg)

<!-- more -->

# Example

- [QQ 物联星球计划](http://qzs.qq.com/iot/act/starplan/index.html?g_f=5757&srctype=61&ticket=)
- [公园全景地图](http://www.onzeonze.com.br/clientes/dreampark/360/)
...
> 通过[`pano2vr`](http://ttl7.pc6.com/gm/pano2vr.zip)直接将鱼眼全景图生成立体空间的六个面；也可通过`Photoshop`或其他的专业 3D 建模工具，将鱼眼图贴到 3D 球面上，再将球面转为立方面，获得立体空间的六个面。
>
> **使用到的 JS 库：**
>
> - three.min.js
> - CSS3DRenderer.js
>
> 源码 Demo：[http://mrleo.github.io/3DPanorama](http://mrleo.github.io/3DPanorama)
>
...
# [基于 Three.js 的 360X180 度全景图预览插件](http://www.htmleaf.com/jQuery/Image-Effects/201508112394.html)
